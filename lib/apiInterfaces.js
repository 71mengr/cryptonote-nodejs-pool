...
var apiInterfacesInstance = null;

function createApiInterfaces(daemonConfig, walletConfig, poolApiConfig) {
    ...
    var obj = {
        ...
        rpcWallet: function(method, params, callback) {
            // Use the same function as rpcDaemon
            obj.rpcDaemon(method, params, callback);
        }
    };
...
module.exports = function(daemonConfig, walletConfig, poolApiConfig) {
    return createApiInterfaces(daemonConfig, walletConfig, poolApiConfig);
};
